...
![image-20230222094922103](https://qnimg.gisfsde.com/markdown/image-20230222094922103.png)
...
### apache-tomcat-9.0.27\conf\server.xml

主配置文件，包含Service, Connector, Engine, Realm, Valve, Hosts主组件的相关配置信息；
...
### apache-tomcat-9.0.27\conf\web.xml
